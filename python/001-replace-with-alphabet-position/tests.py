...
class TestSolution(unittest.TestCase):
    ...
    def test_mixed_characters(self):
        self.assertEqual(alphabet_position("IorYTTfZAomySEGZRVZCaudiPVRKKNsgbRiTpEUUZGeLrmiwCgRcjsdigQwawJpsfcGmqlQUbzeqrOdBfIijkuXLqkhskXKzHCTR"), "9 15 18 25 20 20 6 26 1 15 13 25 19 5 7 26 18 22 26 3 1 21 4 9 16 22 18 11 11 14 19 7 2 18 9 20 16 5 21 21 26 7 5 12 18 13 9 23 3 7 18 3 10 19 4 9 7 17 23 1 23 10 16 19 6 3 7 13 17 12 17 21 2 26 5 17 18 15 4 2 6 9 9 10 11 21 24 12 17 11 8 19 11 24 11 26 8 3 20 18")
